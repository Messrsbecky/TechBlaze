...
const ChatWindow = () => {
  ...
  return (
    <div className="w-full h-screen flex flex-col justify-between bg-green-600 p-5">
      <Header />
        ...
        {messages.map((message, index) => (
          <div
            ...
            className={`p-3 mb-4 rounded-lg border ${
              message.sender === "user"
                ? "self-end bg-gray-300 text-black border-black"
                : "self-start bg-gray-800 text-white border-red-600"
            }`}
          >
            {message.isCode ? (
              <MDEditor.Markdown
