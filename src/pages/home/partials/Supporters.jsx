...
const Supporters = () => {
    return ( 
        <div className="mx-4 items-center w-full mb-60 "> 
            <div><h5 className="text-center mb-10 font-normal " >Proudly supported by</h5></div>
            <div className="flex items-center justify-center no-scrollbar  overflow-x-auto lg:overflow-visible">
