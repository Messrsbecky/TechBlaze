...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#000A0A] footer px-6 py-20 border-2 border-purple-600">
      <div className="flex flex-col gap-12 lg:flex-row lg:justify-between lg:items-center lg:gap-40 border-2 border-blue-500">
        ...
        <section className="lg:w-2/5 border-2 border-orange-300">
          <form onSubmit={handleSubmit} className="mx-auto sm:flex justify-between gap-4 border-2">
